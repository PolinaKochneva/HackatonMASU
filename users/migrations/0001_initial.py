    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hackathon_number', models.ForeignKey(db_column='Hackathon number', on_delete=django.db.models.deletion.DO_NOTHING, to='users.hackathons')),
                ('moderator_number', models.ForeignKey(blank=True, db_column='Moderator id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='users.moderators')),
                ('number', models.ForeignKey(blank=True, db_column='Task id', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='users.tasks')),
            ],
            options={
                'db_table': 'Teams',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.DateTimeField(blank=True, db_column='Start time', null=True)),
                ...
                ('solution_repository_link_field', models.CharField(blank=True, db_column='Solution repository (link)', max_length=100, null=True)),
                ('hackathon_number', models.ForeignKey(db_column='Hackathon number', on_delete=django.db.models.deletion.DO_NOTHING, to='users.hackathons')),
