# Generated by Django 4.1.7 on 2023-04-27 10:12
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            name='Hackathons',
            fields=[
                ('id', models.AutoField(db_column='Hackathon number', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            name='HackathonsRegulations',
            fields=[
                ('id', models.AutoField(db_column='ID', primary_key=True, serialize=False)),
                ('event_date', models.DateField(db_column='Event date')),
                ('event_content', models.CharField(db_column='Event content', max_length=200)),
                ('venue', models.CharField(blank=True, db_column='Venue', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hackathon_number', models.ForeignKey(db_column='Hackathon number', on_delete=django.db.models.deletion.DO_NOTHING, to='users.hackathons')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link_to_the_task_text', models.CharField(blank=True, db_column='Link to the task text', max_length=200, null=True)),
                ('hackathon_number', models.ForeignKey(db_column='Hackathon number', on_delete=django.db.models.deletion.DO_NOTHING, to='users.hackathons')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(db_column='Organization Representative ID', primary_key=True, serialize=False)),
                ('surname', models.CharField(db_column='Organization representative surname', max_length=100)),
                ('name', models.CharField(db_column='Organization representative name', max_length=100)),
                ('patronymic', models.CharField(blank=True, db_column='Organization representative patronymic', max_length=100, null=True)),
                ('email', models.CharField(db_column='Organization representative email', max_length=100, unique=True)),
                ...
                ('number', models.ForeignKey(db_column='Organization number', on_delete=django.db.models.deletion.DO_NOTHING, to='users.participatingorganizations')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('team', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='users.teams')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
